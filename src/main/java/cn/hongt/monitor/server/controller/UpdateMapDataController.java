...
public class UpdateMapDataController {
    ...
    @ApiOperation(value = "更新-服务器内网IP", httpMethod = "POST")
    ...
    @PostMapping("/updateDockerDepMap")
    @ApiOperation(value = "更新-Docker监控-历史监控-配置表", httpMethod = "POST")
    ...
    @PostMapping("/updateLinuxNetWorkList")
    @ApiOperation(value = "更新--服务器网卡监控--缓存信息", httpMethod = "POST")
    ...
    @PostMapping("/updateLinuxDepMap")
    @ApiOperation(value = "更新-Linux监控-历史监控-配置表", httpMethod = "POST")
    ...
    @PostMapping("/updateWarnDepMap")
    @ApiOperation(value = "更新--告警监控-配置表", httpMethod = "POST")
